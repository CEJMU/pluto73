...
\
  ...
  connect_bd_net -net axi_ad9361_dac_enable_i0 [get_bd_pins axi_ad9361/dac_enable_i0] [get_bd_pins tx_upack/enable_0]
  ...
  connect_bd_net -net tx_fir_s_axis_data_tready [get_bd_pins tx_fir/s_axis_data_tready] [get_bd_pins tx_upack/fifo_rd_en]
  connect_bd_net -net tx_sample_enable_0_enable [get_bd_pins tx_cic_i/m_axis_data_tready] [get_bd_pins tx_cic_q/m_axis_data_tready] [get_bd_pins tx_strobe_gen_0/enable]
  ...
  connect_bd_net -net tx_upack_fifo_rd_valid [get_bd_pins tx_fir/s_axis_data_tvalid] [get_bd_pins tx_upack/fifo_rd_valid]
  ...
  connect_bd_net -net xlslice_3_Dout [get_bd_pins tx_cic_config/Dout] [get_bd_pins tx_cic_i/s_axis_config_tdata] [get_bd_pins tx_cic_q/s_axis_config_tdata]
